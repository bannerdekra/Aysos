...
- `SoftWare/Script/` - 所有脚本文件
  ...
  - `theme_manager.py` - **[2025-10-18] 主题管理，支持静态/动态背景自由切换**
  - `enhanced_theme_manager.py` - **[2025-10-18] 增强主题管理器，支持视频背景标记与自动识别**
  - `theme_settings.json` - **[2025-10-19] 主题配置，包含视频背景状态持久化，长文本折叠配置**
- `SoftWare/Image/` - 软件资源
  - `Backgroud/` - UI背景图片
...
- `LOG/` - 日志与说明
  - `UPDATE_2025-09-28.md` / `UPDATE_2025-09-30.md` / `UPDATE_2025-10-05.md` / `UPDATE_2025-10-08.md` / `UPDATE_2025-10-09.md` / `UPDATE_2025-10-10.md` / `UPDATE_2025-10-11.md` / `UPDATE_2025-10-15.md` / `UPDATE_2025-10-16.md` / `UPDATE_2025-10-17.md` / **`UPDATE_2025-10-18.md`** / **`UPDATE_2025-10-19.md`** - 每日更新日志
  - `README.md` - 发布说明
- **🆕 说明文档**：
...
- **🎨 用户体验**：
  ...
  - 设置界面显示当前背景类型标签
- **💾 持久化**：
  - 背景设置自动保存到 `theme_settings.json`
  - 包含 `is_video_background` 标记
  - 应用启动时自动恢复
- **📚 完整文档**：
...
- **2025-10-19 (v1.0.10)**：📖 **长文本智能折叠 + 对话框背景修复**
  ...
  - 💾 **配置持久化**：设置自动保存到 `theme_settings.json`，重启后生效
...
- **2025-10-18 (v1.0.10)**：🎬 **静态/动态背景自由切换 - 完美解决方案**
  ...
  - 📝 修改文件：`chat_ui.py`（架构重构）、`enhanced_theme_manager.py`（视频标记）、`dialogs.py`（类型显示）
